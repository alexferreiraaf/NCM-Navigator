    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="bg-gradient-to-r from-[#6366F1] to-[#3B82F6] p-4 text-primary-foreground shadow-lg md:p-8">
        <div className="mx-auto flex max-w-7xl items-center gap-4">
          <BrainCircuit className="h-12 w-12 shrink-0 md:h-16 md:w-16" />
          <div>
            <h1 className="text-2xl font-bold md:text-5xl">NCM Navigator</h1>
            <p className="mt-1 text-sm opacity-90 md:text-lg">
